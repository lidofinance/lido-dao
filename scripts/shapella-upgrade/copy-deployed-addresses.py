...
key_mapping = {
    'lido_dao_node_operators_registry_implementation': 'app:node-operators-registry/implementation',
    'lido_dao_legacy_oracle_implementation': 'app:node-operators-registry/implementation',
    'lido_dao_steth_implementation_address': 'app:lido/implementation',
    ...
    'lido_dao_validators_exit_bus_oracle_implementation': 'validatorsExitBusOracle/implementation',
    ...
    'lido_dao_withdrawal_queue_implementation': 'withdrawalQueueERC721/implementation',
    'lido_dao_eip712_steth': 'eip712StETH/address',
    'lido_dao_staking_router': 'stakingRouter/address',
    'lido_dao_staking_router_implementation': 'stakingRouter/implementation',
    # 'gate_seal': '',
    'oracle_daemon_config': 'oracleDaemonConfig/address',
    'deployer_eoa': 'deployerEOA',
    'dummy_implementation_address': 'dummyEmptyContract/address',
