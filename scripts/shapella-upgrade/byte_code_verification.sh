...
echo -e ${ORANGE}  ================================================${NC}
../../bytecode-verificator/bytecode_verificator.sh  --solc-version 0.8.9 --remote-rpc-url $REMOTE_RPC --config-json $CONFIG --contract dummyEmptyContract --implementation --local-ganache --skip-compilation
