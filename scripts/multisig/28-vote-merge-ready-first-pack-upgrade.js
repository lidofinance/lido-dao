...
async function createVoting({ web3, artifacts }) {
  ...
  assertRequiredNetworkState(state, REQUIRED_NET_STATE.concat([
    'app:lido', 'app:node-operators-registry', 'app:oracle', 'execLayerRewardsVaultAddress']))
  ...
  const execLayerRewardsVaultAddress = state.execLayerRewardsVaultAddress

  const execLayerRewardsWithdrawalLimitPoints = 2  // see https://github.com/lidofinance/lido-dao/issues/405
  ...
  log(`execLayerRewardsWithdrawalLimitPoints: `, yl(execLayerRewardsWithdrawalLimitPoints))
  ...
  const grantSetExecLayerRewardsVaultRoleCallData = await createGrantRoleForLidoAppCallData('SET_EXEC_LAYER_REWARDS_VAULT_ROLE')
  const grantSetExecLayerRewardsWithdrawalLimitRoleCallData = await createGrantRoleForLidoAppCallData('SET_EXEC_LAYER_REWARDS_WITHDRAWAL_LIMIT_ROLE')
  ...
  const setExecLayerRewardsVaultCallData = {
    to: lidoAddress,
    calldata: await lido.contract.methods.setExecLayerRewardsVault(execLayerRewardsVaultAddress).encodeABI()
  }

  const setExecLayerRewardsWithdrawalLimitCallData = {
    to: lidoAddress,
    calldata: await lido.contract.methods.setExecLayerRewardsWithdrawalLimit(execLayerRewardsWithdrawalLimitPoints).encodeABI()
  }
  ...
  const encodedUpgradeCallData = encodeCallScript([
    ...
    grantSetExecLayerRewardsVaultRoleCallData,
    grantSetExecLAyerRewardsWithdrawalLimitRoleCallData,
    ...
    setExecLayerRewardsVaultCallData,
...
8) Grant role SET_EXEC_LAYER_REWARDS_VAULT_ROLE to voting
9) Grant role SET_EXEC_LAYER_REWARDS_WITHDRAWAL_LIMIT_ROLE to voting
...
14) Set deployed LidoExecLayerRewardsVault to Lido contract
15) Set Execution Layer rewards withdrawal limit to ${execLayerRewardsWithdrawalLimitPoints} basis points
