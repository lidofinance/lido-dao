...
function pushOracleReport(consensus, oracle, numValidators, clBalance, elRewardsVaultBalance, reportData) {
  return reportOracle(consensus, oracle, { numValidators, clBalance, elRewardsVaultBalance, ...reportData })
}
