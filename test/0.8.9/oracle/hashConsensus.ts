...
import { CONSENSUS_VERSION, EPOCHS_PER_FRAME, GENESIS_TIME, INITIAL_EPOCH, INITIAL_FAST_LANE_LENGTH_SLOTS, SECONDS_PER_SLOT, SLOTS_PER_EPOCH } from "./baseOracle"


export async function deployHashConsensus(admin: string,
  {
    reportProcessor = null as IReportAsyncProcessor | null,
