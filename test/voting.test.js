...
import {
  ...
  VOTING_APP_ID,
  FINANCE_APP_ID,
  TOKEN_MANAGER_APP_ID, AGENT_APP_ID,
} from "./test-helpers";
...
test('Voting ',
  async t => {
    ...
    const [owner, holder1, holder2, holder3, holder4, holder5, sender, recipient] = accounts;
    ...
    // we have 10 holder, so 6 holders is enough to pass voting
