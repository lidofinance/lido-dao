...
async function deployDaoAndPool(appManager, voting) {
  ...
  const [
    ...
    STAKING_PAUSE_ROLE,
    STAKING_RESUME_ROLE,
    SET_EXEC_LAYER_REWARDS_VAULT_ROLE,
    ...
    pool.SET_EXEC_LAYER_REWARDS_VAULT_ROLE(),
    pool.SET_EXEC_LAYER_REWARDS_WITHDRAWAL_LIMIT_ROLE(),
  ...
  await Promise.all([
    ...
    acl.createPermission(voting, pool.address, SET_EXEC_LAYER_REWARDS_VAULT_ROLE, appManager, { from: appManager }),
    acl.createPermission(voting, pool.address, SET_EXEC_LAYER_REWARDS_WITHDRAWAL_LIMIT_ROLE, appManager, { from: appManager }),
