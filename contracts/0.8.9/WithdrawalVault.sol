...
contract WithdrawalVault {
    ...
    /**
      * @notice Withdraw `_maxAmount` of accumulated withdrawals to Lido contract
      * @dev Can be called only by the Lido contract
      * @param _amount Max amount of ETH to withdraw
      */
    function withdrawWithdrawals(uint256 _amount) external {
        ...
        ILido(LIDO).receiveWithdrawals{value: _amount}();
    }
