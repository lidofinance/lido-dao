...
interface IWithdrawalQueue {
    ...
    function finalize(uint256 _nextFinalizedRequestId, uint256 _shareRate, uint256 _minShareRateWithdrawalRequestId) external payable;
...
contract Lido is Versioned, StETHPermit, AragonApp {
    ...
    */
    ...
    struct OracleReportedData {
        ...
        uint256 minShareRateWithdrawalRequestId;
    }
    ...
    */
    function handleOracleReport(
        ...
        uint256 _simulatedShareRate,
        uint256 _minShareRateWithdrawalRequestId
        ...
        return _handleOracleReport(
            OracleReportedData(
                ...
                _simulatedShareRate,
                _minShareRateWithdrawalRequestId
            )
        );
    }
    ...
    */
    ...
    function _collectRewardsAndProcessWithdrawals(
        ...
        if (_etherToLockOnWithdrawalQueue > 0) {
            IWithdrawalQueue(_contracts.withdrawalQueue).finalize
                .value(_etherToLockOnWithdrawalQueue)
                (_lastFinalizableRequestId, _simulatedShareRate, _minShareRateWithdrawalRequestId);
        }
    ...
    /**
     * @dev return amount of shares to burn depending on the finalization parameters
     */
    function _calculateWithdrawals(
        ...
        return withdrawalQueue.getFinalizationSharesAmount(_reportedData.lastFinalizableRequestId);
    }
    ...
    struct OracleReportContext {
        ...
        uint256 ethToMoveFromWithdrawalsVault;
        uint256 ethToMoveFromELRewardsVault;
        uint256 simulatedSharesToBurn;
        uint256 sharesToBurn;
        uint256 sharesMintedAsFees;
    }
    ...
    function _handleOracleReport(OracleReportedData memory _reportedData) internal returns (uint256[4]) {
        ...
        // Step 3.
        // Pre-calculate the shares to be burnt on withdrawal queue
        // for withdrawal requests to finalize
        if (_reportedData.lastFinalizableRequestId != DONT_FINALIZE_WITHDRAWALS) {
            reportContext.sharesToBurnFromWithdrawalQueue = _calculateWithdrawals(contracts, _reportedData);
        ...
        _collectRewardsAndProcessWithdrawals(
            ...
            _reportedData.minShareRateWithdrawalRequestId
        );
